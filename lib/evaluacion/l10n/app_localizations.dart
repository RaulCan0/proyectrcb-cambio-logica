...
abstract class AppLocalizations {
  ...
  /// No description provided for @writeObservation.
  ///
  /// In en, this message translates to:
  /// **'You must write an observation.'**
  String get writeObservation;

  /// No description provided for @selectSystem.
  ///
  /// In en, this message translates to:
  ...
  ///
  /// In en, this message translates to:
  /// **'Could not get the image: {error}'**
  String imageUploadError(Object error);

  /// No description provided for @modifyRatingTitle.
  ///
  /// In en, this message translates to:
  /// **'Modify rating'**
  String get modifyRatingTitle;

  /// No description provided for @modifyRatingContent.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @drawerResults.
  ///
  /// In en, this message translates to:
  /// **'Results'**
  String get drawerResults;

  /// No description provided for @drawerDetailEvaluation.
  ///
  /// In en, this message translates to:
  /// **'Evaluation Detail'**
  String get drawerDetailEvaluation;
  ...
  /// No description provided for @drawerMyNotes.
  ///
  /// In en, this message translates to:
  /// **'My Notes'**
  String get drawerMyNotes;
}
