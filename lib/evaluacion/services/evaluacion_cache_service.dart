...
class EvaluacionCacheService {
  // Claves únicas para evitar conflictos y asegurar integridad
  ...
  /// Limpia solo la tablaDatos cacheada
  ...
  /// Calcula los promedios por sistema en base a los datos guardados
