                              ...
                              child: ExpansionTile(
                                ...
                                title: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      '${entry.value.where((p) => comportamientosEvaluados.contains(p.benchmarkComportamiento.split(":").first.trim())).length} de ${entry.value.length} comportamientos evaluados',
                                      ...
                                      final resultado = await Navigator.push<String>(
                                        ...
                                        MaterialPageRoute(
                                          builder: (_) => ComportamientoEvaluacionScreen(
                                            ...
                                            empresaId: widget.empresa.id,
                                            asociadoId: widget.asociado.id, dimension: '',
                                          ),
                                        ),
                                      );
