...
class _HistorialScreenState extends State<HistorialScreen> {
  ...
  void _mostrarArchivosEmpresa(dynamic empresa) {
    ...
    final wordUrl = 'https://hdwbaswbinbjbnziwsyu.supabase.co/storage/v1/object/public/reportes/Reporte_$nombre.docx';
    final shingoUrl = 'https://hdwbaswbinbjbnziwsyu.supabase.co/storage/v1/object/public/shingo_report/shingo_${empresa.id}_${empresa.evaluacionId}.pdf';
        ...
        child: Column(
          ...
          children: [
            ...
            ListTile(
              ...
              title: Text('Reporte_$nombre.docx'),
              onTap: () => _abrirUrl(wordUrl),
            ),
            ListTile(
              leading: const Icon(Icons.auto_graph, color: Colors.deepPurple),
              title: Text('Reporte Shingo'),
              onTap: () => _abrirUrl(shingoUrl),
            ),
          ],
        ),
      ),
