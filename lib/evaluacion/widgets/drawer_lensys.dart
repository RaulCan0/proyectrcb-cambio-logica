    ...
    return Drawer(
      child: Container(
        color:
            Theme.of(
              context,
            ).scaffoldBackgroundColor, // Cambiado para usar el color del tema
        child: ListView(
          ...
          children: [
            FutureBuilder<Map<String, dynamic>>(
              ...
              builder: (context, snapshot) {
                ...
                return UserAccountsDrawerHeader(
                  decoration: const BoxDecoration(color: Color(0xFF003056)),
                  accountName: Text(
                    nombre,
                    style: TextStyle(
                  ...
                  currentAccountPicture:
                      (fotoUrl != null &&
                              fotoUrl
                                  .isNotEmpty) // Asegúrate que fotoUrl no sea un string vacío
                          ? CircleAvatar(
            ...
            ListTile(
              ...
              onTap: () {
                Navigator.of(
                  context,
                ).pop(); // Cierra el endDrawer (DrawerLensys)
